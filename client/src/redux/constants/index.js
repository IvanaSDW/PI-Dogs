...
export const WORKING_ON_DELETE = "WORKING_ON_DELETE";
...
export const SET_OPENED_DETAIL_TRUE = 'SET_OPENED_DETAIL_TRUE';
export const SET_OPENED_DETAIL_FALSE = 'SET_OPENED_DETAIL_FALSE';
export const DELETE_BREED_BY_ID_SUCCESS = 'DELETE_BREED_BY_ID_SUCCESS';
export const DELETE_BREED_BY_ID_ERROR = 'DELETE_BREED_BY_ID_ERROR';
